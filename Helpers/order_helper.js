...
const generateInvoicepdf1 = require("../Bootstrap/custonJsFiles/generateInvoiceHtml2");
const generateInvoicePdf = require("../Bootstrap/custonJsFiles/generateInvoicePdf");
...
module.exports = {
  ...
  cancelOrder: async (req, res) => {
    ...
    paidPrice = req.body.finalPrice;

    const paymentMethod = req.body.paymentMethod;
    console.log("finalPrice", paidPrice);
    console.log("paymentMethod", paymentMethod);
    ...
    try {
      ...
      if (order.status === "Delivered") {
        ...
        if (paymentMethod !== "cashOnDelivery") {
          console.log("cancel order u will get refund");
          await updateWallet(userId, paidPrice);
          walletTransaction = new WalletTransactionCollection({
            user: userId,
            orderInfo: req.body.orderId,
            type: "credit",
            amount: paidPrice,
...
const updateWallet = async (userId, paidPrice) => {
  ...
  try {
    ...
    user.wallet = Number(user.wallet) + Number(paidPrice);
