...
const orderHelper = require("./Helpers/Admin_Helpers/ordermanagement_helper");
...
handlebars.registerHelper("getProductDetails", orderHelper.getProductDetails);
...
// Custom Handlebars helper to compare ObjectId values

// Custom Handlebars helper to compare ObjectId values
handlebars.registerHelper(
  "compareObjectId",
  function (objectId1, objectId2, options) {
    if (String(objectId1) === String(objectId2)) {
      return options.fn(this);
    } else {
      return options.inverse(this);
    }
